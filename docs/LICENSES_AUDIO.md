...
## 2026-09-22 — звук лиан / корней

**Falling tree in woods — nematoki**
- Pixabay source ID: `390782`
- Страница: https://pixabay.com/sound-effects/nature-falling-tree-in-woods-390782/
- Категория на Pixabay: Nature / Falling Tree.
- Длительность исходника: около 8 секунд.
- Исходный файл сохранён на Google Drive как `nematoki-falling-tree-in-woods-390782_source.mp3`, Drive ID `1G49imiwsQlLDR6Edjn3IN2RtyX1oyj8M`.
- Рабочий фрагмент сохранён как `nematoki-falling-tree-in-woods-390782_crop_4.00-6.55.mp3`, Drive ID `1WJJ7LOS4vs7trPssqSYDC9pJB9z6A_wt`.
- Production-файл: `audio/sfx/vines_break_falling_tree.mp3`.
- Используется фрагмент примерно **4.00–6.55 с** с коротким fade-in/fade-out.
- Назначение: разрушение **лиан / корней**, включая разрушение молотком.

Проверка лицензии на 2026-09-22:
- применяется Pixabay Content License;
- разрешено бесплатное коммерческое и некоммерческое использование;
- разрешены модификация и адаптация;
- указание автора не обязательно;
- запрещено распространять исходный контент как самостоятельный standalone-файл;
- использование отредактированного фрагмента как SFX внутри игры относится к использованию в составе более крупной творческой работы.

Перед релизом сохранять вместе с остальными доказательствами:
1. URL индивидуальной страницы;
