...
class Boot extends Phaser.Scene{
  ...
  preload(){
    ...
    const I=(k,p)=>this.load.image(k,p+'?v=ui-20260917-royal-panel');
    ...
    I('popup_royal_shop','assets/ui/popups/popup_shop_main.png');I('king_shop_icon','assets/ui/icons/king_shop.png');
